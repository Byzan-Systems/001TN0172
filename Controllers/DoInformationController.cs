...
namespace HDFCMSILWebMVC.Controllers
{
        ...
        public DOInformationViewModel GetDoDetails(string do_number)
        {
            ...
            try
            {
                using (var db = new Entities.DatabaseContext())
                {
                    ...
                    viewModel.Invoicelist = db.Set<InvoiceDetails>().FromSqlInterpolated($@"EXEC SP_GetDetails_Web @Task = {"Get_DoDetailsAsInvoice"}, @Search1 = {do_number ?? ""},  @Search2 = {""}, @Search3 = {""}, @Search4 = {""}, @Search5 = {""},  @Search6 = {""},  @Search7 = {""}").ToList();
                    ...
                    //var orderQuery = $@"EXEC SP_GetDetails_Web @Task = {"Get_DoDetailsAsOrder"}, @Search1 = {do_number ?? ""}, @Search2 = {""}, @Search3 = {""}, @Search4 = {""}, @Search5 = {""}, @Search6 = {""}, @Search7 = {""}";
                    viewModel.orderlist = db.Set<OrderDetails>().FromSqlInterpolated($@"EXEC SP_GetDetails_Web @Task = {"Get_DoDetailsAsOrder"}, @Search1 = {do_number ?? ""},  @Search2 = {""}, @Search3 = {""}, @Search4 = {""}, @Search5 = {""},  @Search6 = {""},  @Search7 = {""}").ToList();
                    //viewModel.orderlist = db.Set<OrderDetails>().FromSqlInterpolated(orderQuery).ToList();
 ...
 //viewModel.CashopsList = db.Set<CashOPSDetails>().FromSqlRaw(cashOpsQuery).ToList();
                    ...
                    viewModel.PaymentList = db.Set<PaymentDetails>().FromSqlInterpolated($@"EXEC Get_DoDetailsAsPayment @Task = {"Get_DoDetailsAsInvoice"}, @Search1 = {do_number ?? ""},  @Search2 = {""}, @Search3 = {""}, @Search4 = {""}, @Search5 = {""},  @Search6 = {""},  @Search7 = {""}").ToList();
